...
vi.mock('@/features/test/useABTests', () => ({
  useABTests: () => ({ tests: [], isLoading: false, error: null, deleteTest: vi.fn(), deleteTests: vi.fn(), refresh: vi.fn() }),
}));
vi.mock('@/features/project/useProjects', () => ({
  useProjects: () => ({ projects: [], isLoading: false, error: null, deleteProject: vi.fn(), refresh: vi.fn() }),
}));
vi.mock('@/features/test/api', () => ({ updateTest: vi.fn(), deleteTest: vi.fn() }));
vi.mock('@/features/project/api', () => ({ addTestToProject: vi.fn() }));
