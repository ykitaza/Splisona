...
- [x] 3. バックエンド: 評価オーケストレーターを実装する

- [x] 3.1 AI 評価オーケストレーターを実装する
...
- [x] 4. バックエンド: レポートサービスを実装する

- [x] 4.1 結果レポート集計サービスを実装する
...
- [x] 6. フロントエンド: ペルソナ関連画面を実装する

- [x] 6.1 ダッシュボード画面を実装する
...
- [x] 7. (P) フロントエンド: A/B テスト・レポート画面を実装する

- [x] 7.1 テスト作成フロー画面を実装する
...
- [x] 8.1 フロントエンドの API クライアントを実装して全エンドポイントを接続する
...
- [ ] 8.2 本番 CDK デプロイと E2E スモークテストを実施する  <!-- 手動デプロイ作業: cdk deploy → Bedrock モデルアクセス有効化 → E2E 確認 -->
